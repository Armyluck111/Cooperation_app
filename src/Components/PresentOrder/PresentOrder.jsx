...
actions.resetForm();
  ...
  return (
    ...
    >
      <Form className="col-5 ContactInfo" style={{backgroundColor:"rgba(0, 0, 0, 0.600)"}}>
      <FontAwesomeIcon icon={faCircleXmark} className="closeForm" onClick={(e)=>setform(false)}/>
        <label className="label">
          الجهة المساهمة <span>*</span>
        </label>
        <label><Field type="radio" value="مطعم" name="present" className="presentField" />مطعم</label>
        
        <label><Field type="radio" value="جمعية خيرية" name="present"  className="presentField" />جمعية خيرية</label>
        <label><Field type="radio" value="متطوع" name="present"  className="presentField"/>متطوع</label>
        ...
        <Field type="text" placeholder=" رقم التليفون.........." name="phone"  className="presentField"/>
        <span className="text-danger">
